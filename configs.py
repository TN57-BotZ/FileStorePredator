...
│
├🔸👨‍💻 **Developer:** [𝐌𝐞](https://t.me/flimipediastorebott) 
│
├🔹👥 **Main Channel:** [𝐅𝐥𝐢𝐦𝐢𝐩𝐞𝐝𝐢𝐚](https://t.me/flimipedia)
│
├🔸🔔 **Status:** [𝐃𝐩 𝐄&𝐂](https://t.me/Dp_Editing_and_Creations)
│
╰──────[ 😎 ]───────────⍟
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 **𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿:** [𝐌𝐞](https://t.me/flimipediastorebott) 

𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 𝐢𝐬 𝐒𝐮𝐩𝐞𝐫 𝐍𝐨𝐨𝐛. 𝐉𝐮𝐬𝐭 𝐋𝐞𝐚𝐫𝐧𝐢𝐧𝐠 𝐟𝐫𝐨𝐦 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥 𝐃𝐨𝐜𝐬. 𝐀𝐧𝐝 𝐒𝐞𝐞𝐤𝐢𝐧𝐠 𝐇𝐞𝐥𝐩 𝐅𝐫𝐨𝐦 𝐏𝐫𝐨 𝐂𝐨𝐝𝐞𝐫𝐬\n**@Dp_Editing_and_Creations**
...
[**Donate Me**](balajiramar5@okaxis) (G-PAY)
"""
	HOME_TEXT = """
Hello, [{}](tg://user?id={})\n\nThis is a Permanent **FileStore Bot**.
